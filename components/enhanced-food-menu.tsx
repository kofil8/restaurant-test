...
const foodItems: FoodItem[] = [
  {
    ...
    description:
      "Freshly mashed avocado on artisanal sourdough bread with cherry tomatoes and microgreens",
    isPopular: true,
  ...
  },
  {
    ...
    description:
      "Premium aged beef tenderloin with truffle mashed potatoes and red wine reduction",
    isPopular: true,
  ...
  },
  {
    ...
    description:
      "Refreshing acai smoothie bowl topped with fresh berries, banana, and house-made granola",
  ...
  },
  {
    ...
    description:
      "Fresh garden vegetables with feta cheese, olives, and our signature herb vinaigrette",
    isPopular: true,
  ...
  },
  {
    ...
    description:
      "Creamy Arborio rice with wild mushrooms, finished with black truffle and aged Parmesan",
          ...
          {selectedTags.length > 0 && (
            <span>
              ...
              {selectedTags.map((tag) => (
                <span
                  key={tag}
                  className='inline-block bg-red-100 text-red-600 px-2 py-0.5 rounded-full text-xs mx-1'
                >
                  {tag}
                </span>
              ))}
